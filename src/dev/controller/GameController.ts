...
namespace Dev.Controller{
    ...
    export class GameController extends Core.Controller.GameController {
        ...
        private onGameAnimationAction(action : Dev.Enum.GameAnimListener):void {
            this.emit(Enum.Listeners.OnGameAnimAction,action,this.dataController.data);
        } 

        private onGameAnimationStateAction(action : Dev.Enum.AnimationStateType):void {
